            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  <div class="text-bold items-center">18415010</div>
                  <div>Irfandi Nofriansyah</div>
                </div>
              </div>
      ...
      <q-scroll-area class="fit">
        <q-list>
          <q-item style="height: 50px;" class="bg-white text-bold text-center">
            <q-item-section>
              Aplikasi Penjualan Spartpart Hp
            </q-item-section>
          </q-item>
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              <q-avatar size="150px" class="q-mb-md">
                <img src="/statics/user.jpg" alt="">
              </q-avatar>
              <div class="text-weight-bold">Irfandi</div>
              <div>CUSTOMER</div>
            </div>
          </q-item>
          <q-item-label
