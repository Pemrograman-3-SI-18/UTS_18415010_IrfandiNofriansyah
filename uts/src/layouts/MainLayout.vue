...
<q-layout view="lHh Lpr lFf">
            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  <div class="text-bold items-center">ADMIN</div>
                </div>
              </div>
    ...
    >
      <q-scroll-area class="fit">
        <q-list>
          <q-item style="height: 50px;" class="bg-white text-bold text-center">
            <q-item-section>
              Aplikasi Penjualan Sparpart Hp
            </q-item-section>
          </q-item>
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              <q-avatar size="100px" class="q-mb-md">
                <img src="/statics/admin.jpg" alt="">
              </q-avatar>
              <div class="text-weight-bold">ADMIN</div>
              <div>Toko Sparpart Hp</div>
            </div>
          </q-item>
          <q-item-label
            header
          ...
          <q-item clickable active-class="active" exact v-ripple to="/admin">
            ...
            <q-item clickable active-class="active" exact v-ripple to="/admin/inputdata">
            <q-item-section avatar>
              <q-icon name="input" />
            </q-item-section>
            <q-item-section>
